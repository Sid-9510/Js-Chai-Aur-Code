...
const { courseInstructure: instructure } = course; // Here at right we take a name of object we want property from, and at left in curly brackets we take a property name and also give another name to that properety to make it easy to use

console.log(instructure);

/*** Json Format for API (Both keys and values are in string form) ***/
...
/*** Sometimes it comes in the form of arrays with objects inside ***/
